...
macro(sge_setup_target TARGET)
	...
	if(ARG_INSTALL_FILES)
		list(POP_BACK ARG_INSTALL_FILES INSTALL_FILES_DESTINATION DESTINATION_KEY)
		if(INSTALL_FILES_DESTINATION AND DESTINATION_KEY)
			if(NOT ARG_INSTALL_FILES)
				message(FATAL_ERROR "Empty INSTALL_FILES.")
			endif()
			if(NOT DESTINATION_KEY STREQUAL "DESTINATION")
				message(FATAL_ERROR "Set INSTALL_FILES without DESTINATION.")
			endif()
			install(FILES ${ARG_INSTALL_FILES} DESTINATION ${INSTALL_FILES_DESTINATION})
		else()
			message(FATAL_ERROR "Invalid INSTALL_FILES.")
		endif()
	endif()
	
	if(ARG_INSTALL_DIRECTORIES)
		list(POP_BACK ARG_INSTALL_DIRECTORIES INSTALL_DIRECTORIES_DESTINATION DESTINATION_KEY)
		if(INSTALL_DIRECTORIES_DESTINATION AND DESTINATION_KEY)
			if(NOT ARG_INSTALL_DIRECTORIES)
				message(FATAL_ERROR "Empty INSTALL_DIRECTORIES.")
			endif()
			if(NOT DESTINATION_KEY STREQUAL "DESTINATION")
				message(FATAL_ERROR "Set INSTALL_DIRECTORIES without DESTINATION.")
			endif()
			install(FILES ${ARG_INSTALL_DIRECTORIES} DESTINATION ${INSTALL_DIRECTORIES_DESTINATION})
		else()
...
macro(sge_add_static_library TARGET)
	message(STATUS "==============================================================")
	message(STATUS "Add static library: ${CMAKE_CURRENT_SOURCE_DIR} - ${TARGET}")
    add_library(${TARGET} STATIC)
    sge_setup_target(${TARGET} ${ARGN})
endmacro()

macro(sge_add_shared_library TARGET)
	message(STATUS "==============================================================")
...
macro(sge_add_executable TARGET)
	message(STATUS "==============================================================")
