...
ctx->_eglGetMscRateANGLE = (PFNEGLGETMSCRATEANGLEPROC)get_proc(libgl, "eglGetMscRateANGLE");
...
ctx->_eglQueryDeviceBinaryEXT = (PFNEGLQUERYDEVICEBINARYEXTPROC)get_proc(libgl, "eglQueryDeviceBinaryEXT");
ctx->_eglDestroyDisplayEXT = (PFNEGLDESTROYDISPLAYEXTPROC)get_proc(libgl, "eglDestroyDisplayEXT");
...
ctx->_eglQuerySupportedCompressionRatesEXT = (PFNEGLQUERYSUPPORTEDCOMPRESSIONRATESEXTPROC)get_proc(libgl, "eglQuerySupportedCompressionRatesEXT");
...
ctx->_eglStreamImageConsumerConnectNV = (PFNEGLSTREAMIMAGECONSUMERCONNECTNVPROC)get_proc(libgl, "eglStreamImageConsumerConnectNV");
ctx->_eglQueryStreamConsumerEventNV = (PFNEGLQUERYSTREAMCONSUMEREVENTNVPROC)get_proc(libgl, "eglQueryStreamConsumerEventNV");
ctx->_eglStreamAcquireImageNV = (PFNEGLSTREAMACQUIREIMAGENVPROC)get_proc(libgl, "eglStreamAcquireImageNV");
ctx->_eglStreamReleaseImageNV = (PFNEGLSTREAMRELEASEIMAGENVPROC)get_proc(libgl, "eglStreamReleaseImageNV");
...
ctx->_eglBindWaylandDisplayWL = (PFNEGLBINDWAYLANDDISPLAYWLPROC)get_proc(libgl, "eglBindWaylandDisplayWL");
ctx->_eglUnbindWaylandDisplayWL = (PFNEGLUNBINDWAYLANDDISPLAYWLPROC)get_proc(libgl, "eglUnbindWaylandDisplayWL");
ctx->_eglQueryWaylandBufferWL = (PFNEGLQUERYWAYLANDBUFFERWLPROC)get_proc(libgl, "eglQueryWaylandBufferWL");
ctx->_eglCreateWaylandBufferFromImageWL = (PFNEGLCREATEWAYLANDBUFFERFROMIMAGEWLPROC)get_proc(libgl, "eglCreateWaylandBufferFromImageWL");
}
