...
PFNEGLGETMSCRATEANGLEPROC _eglGetMscRateANGLE;
...
PFNEGLQUERYDEVICEBINARYEXTPROC _eglQueryDeviceBinaryEXT;
PFNEGLDESTROYDISPLAYEXTPROC _eglDestroyDisplayEXT;
...
PFNEGLQUERYSUPPORTEDCOMPRESSIONRATESEXTPROC _eglQuerySupportedCompressionRatesEXT;
...
PFNEGLSTREAMIMAGECONSUMERCONNECTNVPROC _eglStreamImageConsumerConnectNV;
PFNEGLQUERYSTREAMCONSUMEREVENTNVPROC _eglQueryStreamConsumerEventNV;
PFNEGLSTREAMACQUIREIMAGENVPROC _eglStreamAcquireImageNV;
PFNEGLSTREAMRELEASEIMAGENVPROC _eglStreamReleaseImageNV;
...
PFNEGLBINDWAYLANDDISPLAYWLPROC _eglBindWaylandDisplayWL;
PFNEGLUNBINDWAYLANDDISPLAYWLPROC _eglUnbindWaylandDisplayWL;
PFNEGLQUERYWAYLANDBUFFERWLPROC _eglQueryWaylandBufferWL;
PFNEGLCREATEWAYLANDBUFFERFROMIMAGEWLPROC _eglCreateWaylandBufferFromImageWL;
};
...
#define eglGetMscRateANGLE (glxw_egl->_eglGetMscRateANGLE)
...
#define eglQueryDeviceBinaryEXT (glxw_egl->_eglQueryDeviceBinaryEXT)
#define eglDestroyDisplayEXT (glxw_egl->_eglDestroyDisplayEXT)
...
#define eglQuerySupportedCompressionRatesEXT (glxw_egl->_eglQuerySupportedCompressionRatesEXT)
...
#define eglStreamImageConsumerConnectNV (glxw_egl->_eglStreamImageConsumerConnectNV)
#define eglQueryStreamConsumerEventNV (glxw_egl->_eglQueryStreamConsumerEventNV)
#define eglStreamAcquireImageNV (glxw_egl->_eglStreamAcquireImageNV)
#define eglStreamReleaseImageNV (glxw_egl->_eglStreamReleaseImageNV)
...
#define eglBindWaylandDisplayWL (glxw_egl->_eglBindWaylandDisplayWL)
#define eglUnbindWaylandDisplayWL (glxw_egl->_eglUnbindWaylandDisplayWL)
#define eglQueryWaylandBufferWL (glxw_egl->_eglQueryWaylandBufferWL)
#define eglCreateWaylandBufferFromImageWL (glxw_egl->_eglCreateWaylandBufferFromImageWL)
